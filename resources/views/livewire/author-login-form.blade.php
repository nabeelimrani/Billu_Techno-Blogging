   ...
   @endif
    <form wire:submit.prevent="LoginHandler()" method="post" autocomplete="off" novalidate="">
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('login_id') is-invalid @enderror" placeholder="Enter Email or Username" autocomplete="off" wire:model="login_id">
          @error('login_id')
...
<br>
      <p>Don't have an account? <a href="{{ route('author.signin') }}">Create a new account</a></p>
</div>
